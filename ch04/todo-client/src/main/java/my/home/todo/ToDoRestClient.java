...
import my.home.todo.client.ToDoRestClientProperties;
import my.home.todo.client.domain.ToDo;
import my.home.todo.client.error.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    public ToDoRestClientProperties properties;
    ...
    public ToDo upsert(ToDo toDo) throws URISyntaxException {
        RequestEntity<?> requestEntity =
                new RequestEntity<>(toDo, HttpMethod.POST,
